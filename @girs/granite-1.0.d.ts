...
declare module 'gi://Granite?version=1.0' {
    ...
    export namespace Granite {
        ...
        class DrawingBufferSurface extends GObject.Object {
            ...
            static with_buffer_surface(
                width: number,
                height: number,
                model: DrawingBufferSurface,
        ...
        class WidgetsDynamicNotebook extends Gtk.EventBox {
            ...
            connect_after(
                ...
                callback: (_source: this, duplicated_tab: WidgetsTab) => void,
            ): number;
        ...
        class WidgetsSourceListExpandableItem extends WidgetsSourceListItem {
            ...
            connect_after(
                signal: 'child-added',
                callback: (_source: this, item: WidgetsSourceListItem) => void,
            ): number;
        ...
        class WidgetsWelcomeButton extends Gtk.Button {
            ...
            static ['new'](
                image: Gtk.Image | null,
                option_text: string,
                description_text: string,
            ): WidgetsWelcomeButton;
