import { firstLetterUpper } from "./../../../Util/StringUtil.js";
import { ConfigOption } from "./../../../Util/Config/ConfigOption.js";
import {
  getConfigOptions,
  saveConfig,
} from "./../../../Util/Config/ConfigUtil.js";
import { ConfigType } from "./../../../Util/Config/ConfigType.js";
            ...
            switch (option.getType()) {
              case ConfigType.BOOL:
                valueWidget = Widget.Switch({
                  className: `config-value-switch ${
                    option.getValue() ? "active" : ""
                  }`,
                  onActivate: (self) => {
                    option.setTempValue(self.active);
                    self.className = `config-value-switch ${
                      self.active ? "active" : ""
                    }`;
                  },
                  hexpand: true,
