import {config, setNonEditConfigValue} from "./../../../Util/Config/ConfigUtil.js"
...
export const toggleLightMode = (activeTheme, isActive) => {
	...
	Utils.exec(
		`cp '${themeDir}/${activeTheme}/theme_${isActive ? "light" : "dark"
		}.css' '${App.configDir}/style/colors.css'`
	)
}
...
export const changeTheme = (newThemeName, isLightMode) => {
	...
	Utils.exec(
		...
		}' '${App.configDir}/style/colors.css'`
	)
